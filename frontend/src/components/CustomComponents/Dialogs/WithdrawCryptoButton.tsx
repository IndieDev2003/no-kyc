...
function WithdrawCryptoButton({ trigger,className }: any) {
  const form = useForm();
    ...
    <Dialog>
      ...
      <DialogContent>
        <DialogHeader>
          ...
          <DialogDescription>Withdraw crypto coin's to you preffered account</DialogDescription>
        </DialogHeader>
        <form
          id="sendCrypto"
          onSubmit={(e) => {
              ...
              <Button
                onClick={() =>
                  toast.success("Withdraw Requested Successfully", {
                    description: "Withdraw Successfully Requested",
                  })
                }
              >
                Withdraw
...
export default WithdrawCryptoButton;
